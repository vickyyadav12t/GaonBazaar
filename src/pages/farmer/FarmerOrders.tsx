...
const FarmerOrders = () => {
  ...
  const [orders, setOrders] = useState<Order[]>(mockOrders.filter(o => o.farmerId === 'farmer-1'));
  ...
  const handleAcceptOrder = (orderId: string) => {
    ...
    toast({
      ...
      description: currentLanguage === 'en' ? 'The buyer has been notified.' : 'खरीदार को सूचित किया गया है।',
    });
  };
  ...
  const handleRejectOrder = (orderId: string) => {
    ...
    toast({
      title: currentLanguage === 'en' ? 'Order Rejected' : 'ऑर्डर अस्वीकृत',
      variant: 'destructive',
    });
  };
  ...
  const handleUpdateStatus = (orderId: string, newStatus: string) => {
    ...
    toast({
      title: currentLanguage === 'en' ? 'Status Updated' : 'स्थिति अपडेट',
    });
  };
