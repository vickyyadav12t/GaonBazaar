...
import { mockOrders, mockProducts, mockNotifications } from '@/data/mockData';
...
const FarmerDashboard = () => {
  ...
  const notifications = mockNotifications.filter((n) => n.userId === 'farmer-1');

  const totalEarnings = farmerOrders.filter((o) => o.paymentStatus === 'paid').reduce((sum, o) => sum + o.totalAmount, 0);
