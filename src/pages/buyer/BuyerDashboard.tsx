...
const BuyerDashboard = () => {
  ...
  const totalSpent = buyerOrders.filter(o => o.paymentStatus === 'paid').reduce((sum, o) => sum + o.totalAmount, 0);
  const pendingOrders = buyerOrders.filter(o => o.status === 'pending' || o.status === 'processing').length;
