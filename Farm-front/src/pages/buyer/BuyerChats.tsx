          ...
          {isLoading ? (
            ...
            filteredChats.map((chat) => (
              <Link
                key={chat.id}
                to={`/chat/${chat.id}`}
                className="block rounded-2xl border border-[#d7c7a8] border-l-4 border-l-[#315f3b] bg-[#fffaf0] p-4 shadow-[0_16px_40px_rgba(95,70,40,0.08)] transition hover:shadow-[0_18px_42px_rgba(95,70,40,0.12)]"
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between gap-2">
                      <h3 className="truncate font-semibold text-[#2f3a2f]">{chat.farmerName}</h3>
                      {chat.unreadCount > 0 && (
